package app.ssm.duck.duckapp.Adapter;
...
import app.ssm.duck.duckapp.ui.views.ButtonFlat;
...
//        }
        ...
        viewHolder.mMemberView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.onClick(viewHolder.mMemberView, i);
            }
        });
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        CardView mCardView;
        @InjectView(R.id.dialog_menu)
        ButtonFlat mMemberView;
